...
//        this.game.load.image('ground', 'assets/img/stretchTerrain.png');
        ...
        this.game.load.image('rountHut', 'assets/img/round_rock_hut.png');
...
//        this.rockEmitter.gravity = 0;
        ...
        var clouds = this.game.add.sprite(200, 200, 'clouds');
        var clouds2 = this.game.add.sprite(1400, 250, 'clouds');
